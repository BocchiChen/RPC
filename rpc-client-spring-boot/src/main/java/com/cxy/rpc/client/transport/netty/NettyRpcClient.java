...
import com.cxy.rpc.client.handler.RpcResponseHandler;
import com.cxy.rpc.client.transport.RpcClient;
import com.cxy.rpc.core.codec.RpcFrameDecoder;
import com.cxy.rpc.core.codec.SharableRpcMessageCodec;
...
public class NettyRpcClient implements RpcClient {
    ...
    public RpcMessage sendRpcRequest(RequestMetadata requestMetadata) {
        ...
        if (channel.isActive()) {
            ...
            // 获取请求的序列号 ID
            int sequenceId = requestMetadata.getRpcMessage().getMessageHeader().getSequenceId();
            // 存入还未处理的请求
